...
import { BRAND_NAME, BRAND_HANDLE } from '../brand'

const socials = [
    {
        label: 'GitHub',
        href: `https://github.com/${BRAND_HANDLE}`,
        icon: (
    ...
    {
        label: 'LinkedIn',
        href: `https://linkedin.com/in/${BRAND_HANDLE}`,
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
    ...
    {
        label: 'Instagram',
        href: `https://instagram.com/${BRAND_HANDLE}`,
        icon: (
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
...
export default function NotFound() {
    return (
        <main className="min-h-screen flex flex-col items-center justify-center gap-6 px-4 text-center">
            ...
            <h1
                className="text-[12rem] font-bold leading-none select-none"
            ...
            <p style={{ color: 'var(--color-text-muted)' }}>
                Aber vielleicht findest du mich woanders.
            </p>
